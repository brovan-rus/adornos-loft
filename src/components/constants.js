...
const adornos1 = new URL("../images/adornos11.jpg", import.meta.url);
const adornos2 = new URL("../images/adornos9.jpg", import.meta.url);
const adornos3 = new URL("../images/adornos3.jpg", import.meta.url);
const adornos4 = new URL("../images/adornos8.jpg", import.meta.url);
const adornos5 = new URL("../images/adornos7.jpg", import.meta.url);
const adornos6 = new URL("../images/adornos6.jpg", import.meta.url);
const adornos7 = new URL("../images/adornos5.jpg", import.meta.url);
const adornos8 = new URL("../images/adornos4.jpg", import.meta.url);
const adornos9 = new URL("../images/adornos2.jpg", import.meta.url);
const adornos10 = new URL("../images/adornos10.jpg", import.meta.url);
const adornos11 = new URL("../images/adornos1.jpg", import.meta.url);
